...
public class UserTestData {
    ...
    public static void init() {
        ADMIN = new User("Admin", "admin@javaops.ru", UserFlag.superuser, SANKTPETERSBURG.getId());
        DELETED = new User("Deleted", "deleted@yandex.ru", UserFlag.deleted, SANKTPETERSBURG.getId());
